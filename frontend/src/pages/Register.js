...
const Register = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 pt-11">
      <div className="bg-gray-800 p-10 rounded-lg shadow-md border border-gray-700 max-w-md w-full relative">
        <h2 className="text-3xl font-bold mb-8 text-center text-yellow-500">Register</h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            <label className="block text-gray-300 mb-2">Coal Mine Name:</label>
            <input
              type="text"
              name="CoalName"
              placeholder="Enter Coal Mine Name"
          ...
          <button
            type="submit"
            className="w-full bg-gray-300 text-gray-900 py-3 rounded-md hover:bg-gray-600 transition duration-200"
          >
            Register
          </button>
        </form>
